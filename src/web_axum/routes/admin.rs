...
impl AdminAPI {
    ...
    #[serde(path = "/user/:username", method = "put")]
    ...
    #[serde(path = "/user/:username/password", method = "put")]
    ...
    #[serde(path = "/user/:username", method = "delete")]
    ...
    #[serde(path = "/project/:project_id", method = "post")]
    ...
    #[serde(path = "/project/:project_id", method = "put")]
    ...
    #[serde(path = "/projects", method = "get")]
    ...
    #[serde(path = "/project/:project_id", method = "get")]
    ...
    #[serde(path = "/project/:project_id", method = "delete")]
    ...
    #[serde(path = "/entities", method = "get")]
    ...
    #[serde(path = "/entity/:entity_id", method = "put")]
    ...
    #[serde(path = "/entity/:entity_id", method = "delete")]
